...
class Observation(db.Model):
    ...
    datainiciotarv = db.Column(db.DateTime, nullable=True)
    datalevantamento = db.Column(db.DateTime, nullable=True)
    dataproximolevantamento = db.Column(db.DateTime, nullable=True)
    dataconsulta = db.Column(db.DateTime, nullable=True)
    dataproximaconsulta = db.Column(db.DateTime, nullable=True)
    dataalocacao = db.Column(db.DateTime, nullable=True)
    dataenvio = db.Column(db.DateTime, nullable=True)
    smssendernumber = db.Column(db.String(100), nullable=True)
    smssuporternumber = db.Column(db.String(100), nullable=True)
    dataprimeiracv = db.Column(db.DateTime, nullable=True)
    valorprimeiracv = db.Column(db.Integer, nullable=True)
    dataultimacv = db.Column(db.DateTime, nullable=True)
    valorultimacv = db.Column(db.Integer, nullable=True)
    linhaterapeutica = db.Column(db.String(100), nullable=True)
    ...
    syncStatus = db.Column(Enum(SyncStatusEnum), nullable=True, default=SyncStatusEnum.NotSyncronized)
