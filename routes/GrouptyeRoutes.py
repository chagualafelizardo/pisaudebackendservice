...
@grouptype_bp.route('/grouptype', methods=['GET'])
def get_grouptypes():
    return GrouptypeController.get_all()

@grouptype_bp.route('/grouptype/<int:id>', methods=['GET'])
def get_grouptype(id):
    return GrouptypeController.get_by_id(id)

@grouptype_bp.route('/grouptype', methods=['POST'])
def create_grouptype():
    return GrouptypeController.create()

@grouptype_bp.route('/grouptype/<int:id>', methods=['PUT'])
def update_grouptype(id):
    return GrouptypeController.update(id)

@grouptype_bp.route('/grouptype/<int:id>', methods=['DELETE'])
