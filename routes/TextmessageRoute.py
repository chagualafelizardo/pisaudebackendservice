...
@textmessage_bp.route('/textmessages', methods=['GET'])
def get_textmessages():
    return TextmessageController.get_all()

@textmessage_bp.route('/textmessages/<int:id>', methods=['GET'])
def get_textmessage(id):
    return TextmessageController.get_by_id(id)

@textmessage_bp.route('/textmessages', methods=['POST'])
def create_textmessage():
    return TextmessageController.create()

@textmessage_bp.route('/textmessages/<int:id>', methods=['PUT'])
def update_textmessage(id):
    return TextmessageController.update(id)

@textmessage_bp.route('/textmessages/<int:id>', methods=['DELETE'])
